...
%% Plant parameters,five-axis machine tools
...
%% Plant parameters,three-axis experimental platform
PlantX.J = 0.00009537;     %(kg*m^2)
PlantX.B = 0.0007158;      %(kg*m^2/s)
PlantX.Ka = 0.8268;       %(A/V)
PlantX.Kt = 0.512;       %Nm/A
PlantX.rg = 10/(2*pi);         %mm/rad
PlantX.K = PlantX.Ka*PlantX.Kt*PlantX.rg;   %(N*m^2/V)/1000
...
PlantY.J = 0.0001332; %(kg*m^2)
PlantY.B = 0.0004852; %(kg*m^2/s)
PlantY.Ka = 0.8268;  %(A/V)
PlantY.Kt = 0.512;  %Nm/A
PlantY.rg = 10/(2*pi);    %mm/rad
PlantY.K = PlantY.Ka*PlantY.Kt*PlantY.rg; %(N*m^2/V)/1000
...
% PlantZ.J = 0.00009777; %(kg*m^2) for old table
% PlantZ.B = 0.001188; %(kg*m^2/s) for old table
PlantZ.J = 0.0001006; %(kg*m^2) for new table
PlantZ.B = 0.0002758; %(kg*m^2) for new table
PlantZ.Ka = 0.8268;  %(A/V) for new table
PlantZ.Kt = 0.512;  %Nm/A
PlantZ.rg = 10/(2*pi);    %mm/rad
PlantZ.K = PlantZ.Ka*PlantZ.Kt*PlantZ.rg; %(N*m^2/V)/1000
PlantZ.m = PlantZ.J/PlantZ.K; %(V*s^2/mm)
...
PlantA.J = 0.00004333; %(kg*m^2)
PlantA.B = 0.00009417; %(kg*m^2/s)
PlantA.Ka = 0.8268;  %(A/V)
PlantA.Kt = 0.512;  %Nm/A
PlantA.rg = 1/100;
PlantA.K = PlantA.Ka*PlantA.Kt*PlantA.rg;
...
PlantC.J = 0.00004367; %(kg*m^2)
PlantC.B = 0.00009155; %(kg*m^2/s)
PlantC.Ka = 0.8268;  %(A/V)
PlantC.Kt = 0.512;  %Nm/A
PlantC.rg = 1/100;
PlantC.K = PlantC.Ka*PlantC.Kt*PlantC.rg;
